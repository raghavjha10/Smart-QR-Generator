...
const createQR = async (req, res) => {
  try {
    ...
    // Only "url" type codes are routed through our trackable /api/scan/:id
    // redirect. Other types must encode raw data for scanning apps to work.
    const isTrackable = type === "url";
